...
public interface McsWeightPropertiesMapper {
     ...
     * @return
     */
    @Insert("insert into mcs_weight_properties(id,name,connect_id,ip,remark,is_online) values (#{id},#{name},#{connectId}," +
            "#{ip},#{remark},#{isOnline})")
     ...
     * @return
     */
    @Update("update mcs_weight_properties set name = #{name}, connect_id=#{connectId},ip=#{ip},remark=#{remark}," +
     ...
     * @return
     */
    @Select("select * from mcs_weight_properties where remark = #{remark}")
    McsWeightProperTies getByRemark(@Param("remark") String remark);
    ...
    @Insert("<script>" +
            "insert into mcs_weight_properties(id,name,connect_id,ip,remark,is_online)" +
            "values" +
