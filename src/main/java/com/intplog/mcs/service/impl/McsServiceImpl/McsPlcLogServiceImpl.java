...
public class McsPlcLogServiceImpl implements McsPlcLogService {
    ...
    @Override
    public int inset(McsPlcLog mcsPlcLog) {
        return plcLogMapper.inserts(mcsPlcLog);
    }

    @Override
    public int updatePlcLog(McsPlcLog mcsPlcLog) {
        return plcLogMapper.updateByPrimaryKeys(mcsPlcLog);
    }
