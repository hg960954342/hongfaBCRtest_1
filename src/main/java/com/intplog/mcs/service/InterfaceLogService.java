...
public interface InterfaceLogService {
        ...
        int insertInterfaceLog(String method, Object rq, Date rqTime, jsonDataGcs rp, Date rpTime);
        int insertInterFaceLogByResPCross(String method, Object rq, Date rqTime, jsonDataGcs rp, Date rpTime);
