...
public class McsPlcVariableController {
        ...
        @GetMapping("/Data")
        @ResponseBody
        public Object toData(String plcName, String groupNumber, int page, int limit) {
                String _name = plcName.equals("") ? null : plcName;
                String _group = groupNumber.equals("") ? null : groupNumber;
                return mcsPlcVariableService.getAll(_name, _group, page, limit);
        }
